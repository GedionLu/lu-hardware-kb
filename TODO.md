...
- [ ] ECS 运行 extract_pdf_text.py 验证 XEN197X 全量文本关联
- [ ] 知识库自学习机制 (LLM 接管 + 回流)
- [ ] config_codes 图片补全 (XEN197X 等 image_url 为空)

## Completed
- [x] 步骤质量校验 — 504/504 组级字段已填充, 691 步 → 16 步 None
- [x] 文档去重合并 — dedup_merge.py: 168 组 → 100 组, 68 重复
- [x] 评测自动化 — eval_auto.py + run_eval.sh: 31 条测试集
- [x] PDF 文本提取方案验证 — PyMuPDF block+x-overlap: 100% 准确率
